return {
  {
    'jmbuhr/otter.nvim',
    -- load when editing HTML (or any filetypes you want injections in)
    ft = { 'html', 'vue', 'javascriptreact', 'typescriptreact' },
    dependencies = { 'nvim-treesitter/nvim-treesitter' },
    opts = {
      -- you can tweak these or leave nil to use defaults
      lsp = { diagnostic_update_events = { 'TextChanged' } },
    },
    config = function(_, opts)
      -- we’ll activate per‐buffer via an autocmd below
